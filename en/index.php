			...
			<div class="row">
				...
				<div class="col-md-2">
					...
					<p class="mt-2">
						...
						<a href="https://github.com/edupyter/EDUPYTER39/issues" target="_blank" class="ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="issues"><svg viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill="#3674a9" d="M8 9.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"></path><path fill="#3674a9" d="M8 0a8 8 0 100 16A8 8 0 008 0zM1.5 8a6.5 6.5 0 1113 0 6.5 6.5 0 01-13 0z"></path></svg></a>
					</p>
				</div>

				<div class="col-md-2">
					<h3>EDUPYTER 310</h3>
					<div class="text-muted font-monospace" style="font-size:70%">with Python 3.10.5</div>
					<div class="text-danger font-monospace" style="font-size:70%">for Windows 8.1 and newer</div>
