	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 text-center mt-2">
					<span class="kbd-on">fr</span> <a href="/en" class="kbd-off">en</a>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 offset-md-2">
						<p class="mt-2">Environnement de développement pour l'enseignement et l'apprentissage de Python. Peut être installé sur un disque dur ou une clé USB sans droits administrateur.</p>
						<p class="mt-2">Facile à déployer, à mettre à jour et à enrichir (bibliothèques, modules, applications...).</p>
						<p class="pt-1 font-monospace small" style="color:silver">open source / gratuit</p>
		...
		<div class="container">
			<div class="row">
				...
				<?php
				$download_38 =  "https://github.com/edupyter/EDUPYTER38/releases/download/v1.4/EDUPYTER-38-1.4-setup.exe";
				$download_39 =  "https://github.com/edupyter/EDUPYTER39/releases/download/v1.4/EDUPYTER-39-1.4-setup.exe";
				$download_310 = "https://github.com/edupyter/EDUPYTER310/releases/download/v1.4/EDUPYTER-310-1.4-setup.exe";
				?>
				...
				<div class="col-md-2 offset-md-2">
					...
					<p class="mt-2">
						<a href="<?php echo $download_38; ?>" class="btn btn-download btn-xs mt-2"><svg viewBox="0 0 512 512" version="1.1" width="16" height="16" aria-hidden="true"><path fill="#6c757d" d="M216 0h80c13.3 0 24 10.7 24 24v168h87.7c17.8 0 26.7 21.5 14.1 34.1L269.7 378.3c-7.5 7.5-19.8 7.5-27.3 0L90.1 226.1c-12.6-12.6-3.7-34.1 14.1-34.1H192V24c0-13.3 10.7-24 24-24zm296 376v112c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-24-24V376c0-13.3 10.7-24 24-24h146.7l49 49c20.1 20.1 52.5 20.1 72.6 0l49-49H488c13.3 0 24 10.7 24 24zm-124 88c0-11-9-20-20-20s-20 9-20 20 9 20 20 20 20-9 20-20zm64 0c0-11-9-20-20-20s-20 9-20 20 9 20 20 20 20-9 20-20z"></path></svg><sup class="ms-2 text-muted font-monospace" style="font-size:70%">1.4</sup></a><!--<span class="text-monospace ms-2" style="font-size:60%;color:silver">74 Mo</span>-->
						<a href="https://github.com/edupyter/EDUPYTER38/discussions" target="_blank" class="ms-3 me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="discussions"><svg viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill="#3674a9" d="M1.5 2.75a.25.25 0 01.25-.25h8.5a.25.25 0 01.25.25v5.5a.25.25 0 01-.25.25h-3.5a.75.75 0 00-.53.22L3.5 11.44V9.25a.75.75 0 00-.75-.75h-1a.25.25 0 01-.25-.25v-5.5zM1.75 1A1.75 1.75 0 000 2.75v5.5C0 9.216.784 10 1.75 10H2v1.543a1.457 1.457 0 002.487 1.03L7.061 10h3.189A1.75 1.75 0 0012 8.25v-5.5A1.75 1.75 0 0010.25 1h-8.5zM14.5 4.75a.25.25 0 00-.25-.25h-.5a.75.75 0 110-1.5h.5c.966 0 1.75.784 1.75 1.75v5.5A1.75 1.75 0 0114.25 12H14v1.543a1.457 1.457 0 01-2.487 1.03L9.22 12.28a.75.75 0 111.06-1.06l2.22 2.22v-2.19a.75.75 0 01.75-.75h1a.25.25 0 00.25-.25v-5.5z"></path></svg></a>
				...
				<div class="col-md-2">
					...
					<p class="mt-2">
						...
						<a href="https://github.com/edupyter/EDUPYTER39/discussions" target="_blank" class="ms-3 me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="discussions"><svg viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill="#3674a9" d="M1.5 2.75a.25.25 0 01.25-.25h8.5a.25.25 0 01.25.25v5.5a.25.25 0 01-.25.25h-3.5a.75.75 0 00-.53.22L3.5 11.44V9.25a.75.75 0 00-.75-.75h-1a.25.25 0 01-.25-.25v-5.5zM1.75 1A1.75 1.75 0 000 2.75v5.5C0 9.216.784 10 1.75 10H2v1.543a1.457 1.457 0 002.487 1.03L7.061 10h3.189A1.75 1.75 0 0012 8.25v-5.5A1.75 1.75 0 0010.25 1h-8.5zM14.5 4.75a.25.25 0 00-.25-.25h-.5a.75.75 0 110-1.5h.5c.966 0 1.75.784 1.75 1.75v5.5A1.75 1.75 0 0114.25 12H14v1.543a1.457 1.457 0 01-2.487 1.03L9.22 12.28a.75.75 0 111.06-1.06l2.22 2.22v-2.19a.75.75 0 01.75-.75h1a.25.25 0 00.25-.25v-5.5z"></path></svg></a>
				...
				<div class="col-md-2">
					<h3>EDUPYTER 310</h3>
					<div class="text-muted font-monospace" style="font-size:70%">avec Python 3.10.6</div>
					<div class="text-danger font-monospace" style="font-size:70%">pour Windows 8.1 et plus</div>
...
';
		...
		<div id="footer" class="text-secondary text-center p-4" style="margin-top:80px;">
			...
			<br />
			<small>un bogue, une typo, un commentaire... à propos du site : <span style="color:#3674a9">contact@edupyter.net</span></small>
		</div>
