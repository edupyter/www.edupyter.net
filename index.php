		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 mt-3">
					...
					<h2 class="mt-3">PYTHON + JUPYTERLAB + JUPYTER<br />NOTEBOOK + THONNY + ... + WINDOWS</h2>
				</div>
				<div class="col-md-4 text-center mt-2">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3 offset-md-3">
					<h3>EDUPYTER 39</h3>
					<div class="text-danger font-monospace" style="font-size:70%">avec Python 3.9.9 pour Windows 8.1 et plus</div>
				...
				<div class="col-md-3">
					<h3>EDUPYTER 38</h3>
					<div class="text-danger font-monospace" style="font-size:70%">avec Python 3.8.10 pour Windows 7 et plus</div>
				...
				<div class="col-md-2">
					<a class="btn btn-doc btn-xs mt-3" href="mailto:contact@edupyter.net" target="_blank" role="button">
						...
						<div style="margin-left:25px;">Besoin d'une autre version? &#10141; contact@edupyter.net</div>
					</a>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-4 offset-md-3">
					<h3>EDUPYTER 310</h3>
					<div class="text-danger font-monospace" style="font-size:70%">avec Python 3.10.1 pour Windows 8.1 et plus</div>
...
wrapt                1.13.3
';
					$bibliotheques = preg_replace("/[[:blank:]]+/"," ",$bibliotheques);
		...
		<div id="footer" class="text-secondary text-center p-4" style="margin-top:100px;">
