		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3 offset-md-3">
					<h3>EDUPYTER 39</h3>
					<div class="text-danger font-monospace" style="font-size:70%">avec Python 3.9 pour Windows 8.1 et plus</div>
				...
				<div class="col-md-3">
					<h3>EDUPYTER 38</h3>
					<div class="text-danger font-monospace" style="font-size:70%">avec Python 3.8 pour Windows 7 et plus</div>
				...
				<div class="col-md-2">
					<a class="btn btn-doc btn-xs mt-3" href="mailto:contact@edupyter.net" target="_blank" role="button">
						...
						<div style="margin-left:25px;">Besoin d'une autre version? Faire une demande à contact@edupyter.net</div>
					</a>
				</div>
